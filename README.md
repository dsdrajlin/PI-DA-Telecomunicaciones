...
Para un análisis más detallado se sugiere consultar [EDA_Super.ipynb](EDA_Super.ipynb). No obstante, podemos afirmar que, basándonos en estos criterios, las provincias que representan mejores oportunidades de crecimiento a corto plazo son:
* Capital Federal
* Santiago Del Estero
* Corrientes
* Entre Rios
